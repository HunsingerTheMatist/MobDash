...
scoreboard players operation @s md_score += @n[distance=..1,type=marker,tag=md_target,tag=md_killed] md_score
scoreboard players operation @p[tag=md_current] md_player_scores += @n[distance=..1,type=marker,tag=md_target,tag=md_killed] md_score
