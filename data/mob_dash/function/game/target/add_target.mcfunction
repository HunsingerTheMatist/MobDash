...
execute if entity @n[distance=..1,type=marker,tag=md_prev_selected,tag=md_nether] run tag @e[distance=..1,type=marker,tag=md_eligible,tag=md_nether] remove md_eligible
...
tag @e[distance=..1,type=marker,tag=md_prev_selected] remove md_prev_selected
execute as @n[distance=..1,type=marker,tag=md_selected_new] run function mob_dash:game/target/setup_new_target
