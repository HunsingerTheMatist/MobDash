...
execute as @e[distance=0,type=marker,tag=md_eligible] run scoreboard players operation $MaxChoice md_state += @s md_weight
...
execute as @e[distance=0,type=marker,tag=md_eligible] run function mob_dash:game/target/get_mob_from_choice
