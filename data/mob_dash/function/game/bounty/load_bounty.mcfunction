...
# Set default configs
execute unless score $BountyMinCountdown md_config matches 1.. run scoreboard players set $BountyMinCountdown md_config 8
execute unless score $BountyMaxCountdown md_config matches 1.. run scoreboard players set $BountyMaxCountdown md_config 12
