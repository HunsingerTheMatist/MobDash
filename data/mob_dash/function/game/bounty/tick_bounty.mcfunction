...
execute if score $BountyTick md_state matches ..0 run return run function mob_dash:game/bounty/add_bounty

scoreboard players set #bounty_countdown_minute md_state 1200

# Update the sidebar display
execute if entity @n[distance=..1,type=marker,tag=md_bounty,tag=md_selected] run return run function mob_dash:game/bounty/display_bounty
