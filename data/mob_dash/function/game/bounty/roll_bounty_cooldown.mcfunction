...
scoreboard players operation #temp md_state = $BountyMaxCountdown md_state
scoreboard players operation #temp md_state -= $BountyMinCountdown md_state
...
scoreboard players operation $BountyTick md_state += $BountyMinCountdown md_state
