...
execute if score #despawn_iter_128_plus md_state > $AnimalTotalChance_128_plus md_state run scoreboard players set #despawn_iter_128_plus md_state 1

# Debug message documenting that the selected mob was not chosen for despawn
execute unless score #debug_animal_handling md_state matches 0 \
    if score #despawn_iter_128_plus md_state > $AnimalDespawnChance_128_plus md_state run \
...
execute if score #despawn_iter_128_plus md_state > $AnimalDespawnChance_128_plus md_state run return 1
