...
scoreboard players operation #total_despawn_chance md_state = $AnimalTotalChance_0_63 md_animal_config
...
execute if score #despawn_iter_0_63 md_state > #total_despawn_chance md_state run scoreboard players set #despawn_iter_0_63 md_state 1

scoreboard players operation #despawn_chance md_state = $AnimalDespawnChance_0_63 md_animal_config
...
execute store result score #should_despawn md_state unless score #despawn_iter_0_63 md_state > #despawn_chance md_state
...
execute if score #should_despawn md_state matches 0 \
    ...
    {text:" (63- "},{score:{objective:md_state,name:"#nondespawn_chance_percentage"},color:blue},{text:"%) "},{selector:"@s"}]
...
execute unless score #debug_animal_handling md_animal_config matches 0 run \
    ...
    {text:" (63- "},{score:{objective:md_state,name:"#despawn_chance_percentage"},color:blue},{text:"%) "},{selector:"@s"}]