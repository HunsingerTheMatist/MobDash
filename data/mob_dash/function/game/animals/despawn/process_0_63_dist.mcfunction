...
execute if score #despawn_iter_0_63 md_state > $AnimalTotalChance_0_63 md_animal_config run scoreboard players set #despawn_iter_0_63 md_state 1

# Debug message documenting that the selected mob was not chosen for despawn
execute if score #despawn_iter_0_63 md_state > $AnimalDespawnChance_0_63 md_animal_config \
...
execute if score #despawn_iter_0_63 md_state > $AnimalDespawnChance_0_63 md_animal_config run return 1
