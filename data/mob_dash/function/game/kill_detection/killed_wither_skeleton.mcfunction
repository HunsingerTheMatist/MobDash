...
execute in mob_dash:mb_markers positioned 0 0 0 as @n[distance=..1,type=marker,tag=md_selected,name="Wither Skeleton"] run function mob_dash:game/award_kill
