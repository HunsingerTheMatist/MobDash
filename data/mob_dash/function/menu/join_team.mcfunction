...
execute in mob_dash:mb_markers positioned 0 0 0 as @e[distance=0,type=marker,tag=md_team] if score @s md_team = @p[tag=md_current] md_team run tellraw @a [{selector:"@p[tag=md_current]"}, {text:" has joined "}, {selector: "@s"}]
