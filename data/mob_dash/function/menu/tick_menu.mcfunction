...
execute unless entity @n[distance=0..,type=marker,tag=md_spawn] at @p align xyz positioned ~0.5 ~ ~0.5 positioned over motion_blocking_no_leaves run function mob_dash:menu/setup_spawn
...
execute as @n[scores={TeamCount=1..}] run function mob_dash:menu/teams/randomize_teams
...
execute as @a[scores={MenuAction=3}] run function mob_dash:menu/teams/display_teams_menu
