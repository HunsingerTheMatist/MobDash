...
execute as @e[distance=..1,type=marker,tag=md_team,tag=!md_chosen] if score @s md_team = #team_idx md_state run return run function mob_dash:menu/randomize_teams_step
