...
execute unless entity @n[distance=0..,type=marker,tag=md_spawn] at @p[tag=md_current] run summon marker ~ ~ ~ {Tags:[md_spawn]}
tp @n[distance=0..,type=marker,tag=md_spawn] @p[tag=md_current]
