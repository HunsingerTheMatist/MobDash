...
execute if entity @s[tag=md_op] run scoreboard players operation $Win md_state = @s WinScore
execute if entity @s[tag=md_op] if score $Win md_state matches ..-1 run scoreboard players set $Win md_state 0
