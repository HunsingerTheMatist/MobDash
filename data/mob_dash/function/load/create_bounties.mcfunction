...
summon marker ~ ~ ~ {CustomName:"Mooshroom",              data: {weight: 5, min_score: 5, max_score: 8}, Tags:[md_bounty, md_mooshroom]}
summon marker ~ ~ ~ {CustomName:"Panda",                  data: {weight: 3, min_score: 7, max_score: 10}, Tags:[md_bounty, md_panda]}
summon marker ~ ~ ~ {CustomName:"Warden",                 data: {weight: 4, min_score: 20, max_score: 30}, Tags:[md_bounty, md_hostile, md_warden]}
summon marker ~ ~ ~ {CustomName:"Creaking",               data: {weight: 3, min_score: 10, max_score: 13}, Tags:[md_bounty, md_hostile, md_night, md_creaking]}
summon marker ~ ~ ~ {CustomName:"Zoglin",                 data: {weight: 3, min_score: 17, max_score: 20}, Tags:[md_bounty, md_hostile, md_nether, md_zoglin]}
...
summon marker ~ ~ ~ {CustomName:"Strider Jockey",         data: {weight: 5, min_score: 10, max_score: 12}, Tags:[md_bounty, md_nether, md_strider_jockey]}
