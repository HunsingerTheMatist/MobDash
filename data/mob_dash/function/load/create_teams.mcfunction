...
summon marker 0 0 0 {Tags:["md_team"], CustomName:'{"text":"The Redstone Reapers","color":"red"}', data:{"team_id": 1}}
team add red {"text":"The Redstone Reapers","color":"red"}
team modify red color red

summon marker 0 0 0 {Tags:["md_team"], CustomName:'{"text":"The Charged Creepers","color":"green"}', data:{"team_id": 2}}
team add green {"text":"The Charged Creepers","color":"green"}
team modify green color green

summon marker 0 0 0 {Tags:["md_team"], CustomName:'{"text":"The Poisonous Pufferfish","color":"yellow"}', data:{"team_id": 3}}
...
execute as @e[type=marker,tag=md_team] store result score @s md_team run data get entity @s data.team_id
