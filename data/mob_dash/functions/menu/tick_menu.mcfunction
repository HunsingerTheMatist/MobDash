...
# World border
execute if score $BorderCooldown md_state matches 0 run execute at @e[type=area_effect_cloud,tag=md_spawn] run worldborder center ~ ~
execute if score $BorderCooldown md_state matches 0 run execute at @e[type=area_effect_cloud,tag=md_spawn] run spawnpoint @a ~ ~ ~
execute if score $BorderCooldown md_state matches 0 run execute at @e[type=area_effect_cloud,tag=md_spawn] run setworldspawn ~ ~ ~
