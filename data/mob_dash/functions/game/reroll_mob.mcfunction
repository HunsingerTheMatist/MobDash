...
execute if entity @s[tag=md_op] if score $TargetCount md_state matches 1 run tag @e[type=area_effect_cloud,tag=md_selected1] add md_killed
execute if entity @s[tag=md_op] if score $TargetCount md_state matches 2 run tag @e[type=area_effect_cloud,tag=md_selected2] add md_killed
execute if entity @s[tag=md_op] if score $TargetCount md_state matches 3 run tag @e[type=area_effect_cloud,tag=md_selected3] add md_killed
