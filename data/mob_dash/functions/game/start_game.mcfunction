...
time set day
tp @a @e[type=area_effect_cloud,tag=md_spawn,limit=1]
...
scoreboard players set @e[type=area_effect_cloud] md_score 0
scoreboard players set @e[type=area_effect_cloud] md_time 0
tag @e[type=area_effect_cloud] remove md_selected
tag @e[type=area_effect_cloud] remove md_selected1
tag @e[type=area_effect_cloud] remove md_selected2
tag @e[type=area_effect_cloud] remove md_selected3
tag @e[type=area_effect_cloud] remove md_prev_selected
...
execute as @e[type=area_effect_cloud,tag=md_team] run function mob_dash:game/count_members
